...
|023|合并k个有序链表|堆 链表 分治|困难|优先级队列 分治|
...
|094|二叉树的中序遍历|树 深度优先搜索|中等|递归 非递归（栈）|
...
|226|翻转二叉树|树|简单|递归 非递归（队列）|
|104|二叉树的最大深度|树 深度优先搜索|简单|递归 非递归（队列）|
...
|:---|:---|:---|:---|:---|
|023|合并k个有序链表|堆 链表 分治|困难|优先级队列 分治|
|215|数组中的第k大元素|堆 分治|中等|小顶堆|
|378|有序矩阵的第k小元素|堆 二分查找|中等|二分查找 小顶堆|
|295|数据流的中位数|堆 设计|困难|大顶堆+小顶堆|
|347|数组的前k高频元素|堆 哈希表|中等|哈希表+小顶堆|

- 图

|题号|题目|标签|难易程度|解法|
|:---|:---|:---|:---|:---|
|207|课程表|图 拓扑排序|中等|广度优先搜索 深度优先搜索|
|210|课程表2|图 拓扑排序|中等|广度优先搜索 深度优先搜索|
